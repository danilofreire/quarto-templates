...
<div class="feature-grid">
  ...
  <div class="feature">
    ...
    <p>Spelling, hyphenation, and date formats all set to <code>lang: en-GB</code> by default.</p>
  </div>
  <div class="feature">
    <div class="ico">↗</div>
...
R users can remove the `jupyter: python3` line from the YAML header and install the [`quarto-r`](https://quarto-dev.github.io/quarto-r/) and [`rmarkdown`](https://rmarkdown.rstudio.com/lesson-1.html) packages instead.
